...
public class ProductServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		switch (action) {
			...
			case "/product/add":
                ...
                break;
            case "/product/edit":
                req.setAttribute("product", productDao.findProductByCode(req.getParameter("code")));
                req.setAttribute("categories", categoryDao.findAllOfCategories());
                req.getRequestDispatcher("/WEB-INF/view/product/edit.jsp").forward(req, resp);
                break;
            case "/product/remove":
                productDao.remove(req.getParameter("code"));
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        Product product = new Product(code, name, amount, price, cateCode);
